...
if [ -f /usr/share/zsh/plugins/vi-mode/vi-mode.plugin.zsh ]; then
...
alias rmf="rm -i" # Removing files interactively
alias rmd="sudo rm -ir" # Removing directories interactively
alias forcerm="rm -fr"  # Force removing files/directories interactively

# Terminal commands
alias v="nvim"
alias cat="bat"
alias shutdown="sudo shutdown now"
alias neofetch="paleofetch | lolcat"
alias cl="clear"
alias initcon="source anaconda3/bin/activate" # Activate Anacona env
alias tmsource="tmux source ~/.config/tmux/tmux.conf" # Source tmux conf file
alias avenv="source env/bin/activate" # Activate Python env
alias zat="zathura" # Read PDF file with Zathura

# CONFIG FILES
alias vzsh="v .zshrc"
alias vkit="v ~/.config/kitty/kitty.conf"
alias valac="v ~/.config/alacritty/alacritty.yml"
alias vqtile="v ~/.config/qtile/config.py"
alias vnvim="cd ~/.config/nvim/ && v"
alias vrof="v ~/.config/rofi/config.rasi"
